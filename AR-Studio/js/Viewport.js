...
function Viewport( editor ) {
	...
	//const face = scene.getObjectByName('face')
	//scene.remove(face);
	const light1 = editor.light1;
	const light2 = editor.light2;
	...
	const grid1 = new THREE.GridHelper( 1, 30, 0x888888 );
	grid1.material.color.setHex( 0x888888 );
	grid1.material.vertexColors = false;
	grid1.rotateX(-Math.PI/2);
	grid.add( grid1 );

	const grid2 = new THREE.GridHelper( 1, 6, 0x222222 );
