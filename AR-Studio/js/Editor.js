...
_DEFAULT_CAMERA.position.set(0.001, -1.198, 0.092 );
//_DEFAULT_CAMERA.rotateX(-Math.PI/2);
//_DEFAULT_CAMERA.rotation.set(-90,0,0);
...
function Editor() {
	...
	//this.scene.clear();
	const light1 = new THREE.DirectionalLight(0xffffff); // white light
	light1.name = 'Light1';
	light1.intensity = 5.00;
	//light1.position = (0.597, 39.109, -35.654);
	light1.translateX(0.597)
	light1.translateY(39.109)
	light1.translateZ(-35.654)
	
	const light2 = new THREE.DirectionalLight(0xffffff);
	light2.name = 'Light2';
	light2.intensity = 5.00;
	//light2.position = (5.000, 30.662, 24.671);
	light2.translateX(5.000)
	light2.translateY(30.662)
	light2.translateZ(24.671)
	...
	//this.addObject(this.light1)
	//this.addObject(this.light2)
